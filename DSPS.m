...
menuid_figprop_ax2_pan = uimenu(menuid_figprop_ax2,'Label','Pan','CallBack',...
    ['figproperties(''pan'',ax2)']);

menuid_figprop_ax1_pan = uimenu(menuid_figprop,'Label','Zoom On','CallBack',...
    ['figproperties(''zoomon'',ax1)']);
menuid_figprop_ax1_pan = uimenu(menuid_figprop,'Label','Zoom Off','CallBack',...
