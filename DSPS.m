...
menuid_save_irr = uimenu(menuid_save);
menuid_save_results = uimenu(menuid_save);
set(menuid_save_irr,'Label','Save iRR','CallBack','savefile_irr');
...
=======
    'set(table,''Data'',[VLF,LF,HF,LFnu,HFnu,LF_HF],''ColumnName'',{''VLF (msÂ²) '','...
    '''LF (msÂ²)'',''HF (msÂ²)'',''LF (n.u)'',''HF (n.u)'',''LF/HF''},''RowName'',''Indexes'');'...
...
menuid_AR = uimenu(menuid_PSD,'Label','Auto Regressive','CallBack',['[F_AR,Pxx_AR,LF_AR,',...
    ...
    'bands_AR] = psdar(iRR,Time,ax2); set(table,''Data'',',...
    '[VLF_AR,LF_AR,HF_AR,LFnu_AR,HFnu_AR,LF_HF_AR],',...
<<<<<<< HEAD
    '''ColumnName'',{''VLF (ms²) '',''LF (ms²)'',''HF (ms²)'',',...
=======
    '''ColumnName'',{''VLF (msÂ²) '',''LF (msÂ²)'',''HF (msÂ²)'',',...
>>>>>>> a4246c034565407677c5d0f26b37f4f7cb4902ec
...
=======
    '{''RÂ²'',''SSE''},''RowName'',''Indexes'');Results.nlinfit.gof=[Par(4),Par(end)];']);
>>>>>>> a4246c034565407677c5d0f26b37f4f7cb4902ec
...
menuid_STAR = uimenu(menuid_TF,'Label','Short Time Auto Regressive','CallBack',[...
    '[Pft,Fft,HF_STAR,LF_STAR,iRR,Time,Fs,window_star,segment_star,overlap_star'...
...
=======
    'xlabel(''Frequency (Hz)'');ylabel(''PSD (msÂ²/Hz)'');', ...
>>>>>>> a4246c034565407677c5d0f26b37f4f7cb4902ec
